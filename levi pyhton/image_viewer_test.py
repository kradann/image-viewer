    ...
    def load_2d_annot(self):
        if self.directory_check():
            if os.path.isfile(os.path.join(self.base_output_dir, self.annotation_filename)):
                with ((open(os.path.join(self.base_output_dir, self.annotation_filename), "r"))as stream):
    ...
    def save_2d(self):
        if self.directory_check():
            ...
            if self.valid_coordinates(self.top_left_x, self.top_left_y, self.bottom_right_x, self.bottom_right_y):
                ...
                annotation_file_path = os.path.join(self.base_output_dir, self.annotation_filename)
